...
import { collection, getDoc, getDocs, updateDoc, query, where, doc } from "firebase/firestore"; // Firestore methods
          ...
          {loading ? (
            ...
            <div className="card shadow-sm">
              ...
              <div className="card-body">
                {classroomData ? (
                  <>
                    <p><strong>Class Name:</strong> {classroomData.courseTitle}</p>
                    <p><strong>Class Name:</strong> {classroomData.instructor}</p>
                    <p><strong>Description:</strong> {classroomData.language}</p>
